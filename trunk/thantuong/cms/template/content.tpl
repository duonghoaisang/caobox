			...
			<tbody class="cat">
				...
				<tr id="{category.id}cat" class="tr_cat{category.row}">
					...
					<span class="hide {action_updatecat}" >
									<a href="?mod=category&amp;p={module}&amp;act=update&amp;id={category.id}&amp;parentid={parentid}&amp;type={type}" title="{button.edit_category}" class="action-edit"><img src="images/icons_default/edit{ucp.edit}.png" width="16" height="16" border="0" /></a></span>
								<span class="hide {category.delcat}">
									<a href="?mod=category&amp;p={module}&amp;act=delete&amp;id={category.id}&amp;parentid={parentid}&amp;type={type}" title="{button.delete_category}" onclick="deleteConfirm(this); return false;" class="action-delete"><img src="images/icons_default/delete{ucp.delete}.png" width="16" height="16" /></a></span></td>
				...
				<tr id="{product.id}pro" class="tr_content{product.row}">
					...
					<td class="th-status lastColumn">
						...
						<span class="hide {action_update}">
							<a href="?mod={module}&amp;act=update&amp;id={product.id}&amp;parentid={parentid}&amp;type={type}" title="{button.edit_item}"><img src="images/icons_default/edit{ucp.edit}.png" width="16" height="16" border="0" /></a></span>
						<span class="hide {product.delrecord}">
							<a href="?mod={module}&amp;act=delete&amp;id={product.id}&amp;parentid={parentid}&amp;type={type}" onclick="deleteConfirm(this); return false;" title="{button.delete_item}"><img src="images/icons_default/delete{ucp.delete}.png" width="16" height="16" /></a></span>
					</td>
				</tr>
				<!--BASIC product-->
			</tbody>
