...
<div id="banner">
  <a href="./"><img src="images/logo.gif" alt="logo" width="120" height="45" border="0" /></a></div>
<div id="nav">
<ul>
	<!--BASIC category-->
...
<div id="content">
	...
	<!--Plugin here-->
	<p  style="display: block; width: 600px; height: 90px; overflow: hidden;">
	<a href="http://www.vbid.vn" title="Sàn Đấu Giá Trực Tuyến VBID.vn. Mời bạn đăng ký & cùng sở hữu cơ hội mua TV, Máy ảnh số, Loa âm thanh, Điện thoại. GIÁ CHỈ VÀI NGHÌN ĐỒNG !"><img src="images/vbid-dau-gia-truc-tuyen.jpg"  /></a></p>
	{include:tpl=body}
</div>
<div id="right">
	<div class="box_user">
	...
	<div class="box">
		...
		<a target="_blank" href="http://www.vbid.vn" title="Sàn Đấu Giá Trực Tuyến VBID.vn. Mời bạn đăng ký & cùng sở hữu cơ hội mua TV, Máy ảnh số, Loa âm thanh, Điện thoại. GIÁ CHỈ VÀI NGHÌN ĐỒNG !">iPhone 4G: Giá 159.140 đ</a><br />
        <a target="_blank" href="http://www.w3seo.com" title="W3 Search Engine Optimization">W3 Search Engine Optimization</a><br />
		<a target="_blank" href="http://vinhlong.thietkeweb-mienphi.com" title="Thiet ke web mien phi tai VINH LONG">Thiet ke web mien phi tai VINH LONG</a>
		<p><br /><a href="http://www.starfishshop.com" target="_blank"><img src="images/starfish.gif" title="StarFish" /></a></p>
		<p><br /><a target="_blank" title="rem cua, man cua" href="http://remcua24h.com"><img width="235" src="http://remcua24h.com/images/wbgallery/t/2010_05/127527566598993.jpeg" alt="Rem Cua"  /></a></p>
		
		<p><br /><a target="_blank" title="may bo dell" href="http://maybodellusa.com"><img width="235" src="http://maybodellusa.com/images/product/8.jpg" alt="May bo dell"  /></a></p>
	</div>
	<div class="box">
