...
<br>
  <table width="100%" border="0" cellspacing="0" cellpadding="1" class="table_list">
    ...
    <tr class="hide" {display_icon}>
      <td width="16%">Icon</td>
      <td width="84%"><input name="icon" type="file" id="icon">
        <input name="current_icon" type="hidden" value="{icon}" title="{icon}" />
        {size_icon}
		<p class="hide" {display_update}>{icon} 
    ...
    <tr class="hide" {display_image}>
      <td>Image</td>
      <td><input name="image" type="file" id="image"><input name="current_image" type="hidden" title="{image}" value="{image}" />
        {size_image}
		<p class="hide" {display_update}>{image} <input type="checkbox" name="checkbox_img" class="no_width" value="checkbox" onclick="deleteImage('current_image');"  /> Delete</p></td>
    </tr>
    <tr class="hide" {display_gallery}>
	  ...
	  <!--BASIC gallery-->
        <tr id="{gallery.id}">
          ...
          <td width="89%">{gallery.title}{gallery.image}</td>
      ...
      </table><p id="add_gallery">+ <a href="#" onclick="add_gallery('#add_gallery');return false">Add</a><br />
	  <input type="file" name="add_gallery0" class="no_width" /><br />
	  </p>
</td>
    </tr>
  </table>
