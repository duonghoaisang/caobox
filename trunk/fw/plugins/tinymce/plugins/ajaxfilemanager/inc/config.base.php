...
$upload_dir =  dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))));
...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', $upload_dir.'/data/upload/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', $upload_dir.'/data/upload/');	//accept relative path only
	define('CONFIG_SYS_FOLDER_SHOWN_ON_TOP', true); //show your folders on the top of list if true or order by name 
	define("CONFIG_SYS_DIR_SESSION_PATH", $upload_dir.'/data/cache/');
