...
<input name="act[]" type="checkbox" class="no_width" id="act[]" value="featuredon" {featuredon_checked}>
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
	  ...
	  <!--BASIC main_field-->
      <tr>
        <td><input type="checkbox" id="main_field_{main_field.code}" name="main_fields[{main_field.code}][chose]" {main_field.chose_checked} value="1" />
          <label for="main_field_{main_field.code}">{main_field.code}</label><a href="#" title="Type: {main_field.Type} Null: {main_field.Null} Default: {main_field.Default}">?</a></td>
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
	  ...
	  <!--BASIC ln_field-->
      <tr>
        <td><input type="checkbox" id="ln_field_{ln_field.code}" name="ln_fields[{ln_field.code}][chose]" {ln_field.chose_checked} value="1" />
          <label for="ln_field_{ln_field.code}">{ln_field.code}</label><a href="#" title="Type: {ln_field.Type} Null: {ln_field.Null} Default: {ln_field.Default}">?</a></td>
  ...
  <tr>
    ...
    <td> 
	  ...
	  Resize <input name="main_icon[w]" type="text" class="no_width" id="main_icon[w]" size="2" maxlength="3" value="{main_icon_w}">
      x
...
No 
  ...
  <tr>
	...
	Resize <input name="main_img[w]" type="text" class="no_width" id="main_img[w]" size="2" maxlength="3" value="{main_img_w}">
      x
      <input name="main_img[h]" type="text" class="no_width" id="main_img[h]" size="2" maxlength="3" value="{main_img_h}"> File name:<input name="main_img[name]" type="text" class="no_width" id="main_img[name]"  value="{main_img_name}">
<div class="resize_toggle_advance"><a href="#" onclick="return resize_toggle_advance(this);">Advandce</a>
...
No 
  ...
  <tr>
    <td><input name="main_thumb[chose]" type="checkbox" class="no_width" id="main_thumb[chose]" value="1" {main_thumb_chose}>
      Image Thumb </td>
    <td>
Resize <input name="main_thumb[w]" type="text" class="no_width" id="main_thumb[w]" size="2" maxlength="3" value="{main_thumb_w}">
      x
...
Max </td>
  ...
  <tr>
    <td width="200"><input name="ln_main_icon[chose]" type="checkbox" class="no_width" id="ln_main_icon[chose]" value="1" {ln_main_icon_chose}>
      Icon</td>
    <td>
Resize <input name="ln_main_icon[w]" type="text" class="no_width" id="ln_main_icon[w]" size="2" maxlength="3" value="{ln_main_icon_w}">
      x
      
      <input name="ln_main_icon[h]" type="text" class="no_width" id="ln_main_icon[h]" size="2" maxlength="3" value="{ln_main_icon_h}"> File name: 	<input name="ln_main_icon[name]" type="text" class="no_width" id="ln_main_icon[name]"  value="{ln_main_icon_name}">
<div class="resize_toggle_advance"><a href="#" onclick="return resize_toggle_advance(this);">Advandce</a>
...
No 
  ...
  <tr>
    <td><input name="ln_main_img[chose]" type="checkbox" class="no_width" id="ln_main_img[chose]" value="1" {ln_main_img_chose}>
      Image</td>
    <td>
	Resize <input name="ln_main_img[w]" type="text" class="no_width" id="ln_main_img[w]" size="2" maxlength="3" value="{ln_main_img_w}">
      x
      <input name="ln_main_img[h]" type="text" class="no_width" id="ln_main_img[h]" size="2" maxlength="3" value="{ln_main_img_h}"> File name: <input name="ln_main_img[name]" type="text" class="no_width" id="ln_main_img[name]"  value="{ln_main_img_name}">
<div class="resize_toggle_advance"><a href="#" onclick="return resize_toggle_advance(this);">Advandce</a>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="29%" bgcolor="#eeeeee">Method</td>
...
No 
  ...
  <tr>
    <td><input name="ln_main_thumb[chose]" type="checkbox" class="no_width" id="ln_main_thumb[chose]" value="1" {ln_main_thumb_chose}>
      Image Thumb </td>
    <td>
	Resize <input name="ln_main_thumb[w]" type="text" class="no_width" id="ln_main_thumb[w]" size="2" maxlength="3" value="{ln_main_thumb_w}">
      x
...
Max </td>
  ...
  <tr>
    <td width="200"><input name="gallery_icon[chose]" type="checkbox" class="no_width" id="gallery_icon[chose]" value="1" {gallery_icon_chose}>
      Icon</td>
    <td>
	Resize <input name="gallery_icon[w]" type="text" class="no_width" id="gallery_icon[w]" size="2" maxlength="3" value="{gallery_icon_w}" />
x
<input name="gallery_icon[h]" type="text" class="no_width" id="gallery_icon[h]" size="2" maxlength="3" value="{gallery_icon_h}" /> File name: <input name="gallery_icon[name]" type="text" class="no_width" id="gallery_icon[name]" value="{gallery_icon_name}" />
	<div class="resize_toggle_advance"><a href="#" onclick="return resize_toggle_advance(this);">Advandce</a>
...
No 
  ...
  <tr>
	...
	Resize <input name="gallery_img[w]" type="text" class="no_width" id="gallery_img[w]" size="2" maxlength="3" value="{gallery_img_w}">
      x
      <input name="gallery_img[h]" type="text" class="no_width" id="gallery_img[h]" size="2" maxlength="3" value="{gallery_img_h}"> File name: <input name="gallery_img[name]" type="text" class="no_width" id="gallery_img[name]" value="{gallery_img_name}" />
		<div class="resize_toggle_advance"><a href="#" onclick="return resize_toggle_advance(this);">Advandce</a>
...
No 
  ...
  <tr>
    <td><input name="gallery_thumb[chose]" type="checkbox" class="no_width" id="gallery_thumb[chose]" value="1" {gallery_thumb_chose}>
      Image Thumb </td>
    <td>
	Resize: <input name="gallery_thumb[w]" type="text" class="no_width" id="gallery_thumb[w]" size="2" maxlength="3" value="{gallery_thumb_w}">
      x
...
Max </td>
 ...
 <h2 class="cfg_title">Category</h2>
 <table width="100%" border="0" cellspacing="0" cellpadding="2" class="table-Form1 table_list">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        <td><input type="checkbox" name="cat_fields[{cat_field.code}][chose]" {cat_field.chose_checked} value="1" />
          {cat_field.code} <a href="#" title="Type: {cat_field.Type} Null: {cat_field.Null} Default: {cat_field.Default}">?</a></td>
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        <td><input type="checkbox" name="ln_catfields[{ln_catfield.code}][chose]" {ln_catfield.chose_checked} value="1" />
          {ln_catfield.code} <a href="#" title="Type: {ln_catfield.Type} Null: {ln_catfield.Null} Default: {ln_catfield.Default}">?</a></td>
    ...
    <tr>
      ...
      <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
			...
			<!--BASIC catoptions-->
            <tr>
              <td><input name="catoptions[]" class="no_width" type="checkbox" id="catoptions[]" value="{catoptions.typeid}" {catoptions.checked} /> {catoptions.name}</td>
              <td><select name="catoptions_type[{catoptions.typeid}]">
            <option value="0" {catoptions.selected_0}>Radio</option>
            <option value="1" {catoptions.selected_1}>Checkbox</option>
            <option value="2" {catoptions.selected_2}>Dropdown</option>
            <option value="3" {catoptions.selected_3}>Dropdown with multi select</option>
          </select></td>
              <td><input type="text" name="catoptions_save_field[{catoptions.typeid}]" value="{catoptions.catoptions_save_field}" /></td>
            </tr>
			<!--BASIC catoptions--> 
          </table></td>
    </tr>
    <tr>
      <td>File extra </td>
      <td><table width="666" border="0" cellpadding="1" cellspacing="1" id="catfile_extra">
          <tr>
            <td width="144" bgcolor="#eeeeee">Name <a href="#" title="Leave a blank for any extension ">?</a></td>
            <td width="39" bgcolor="#eeeeee">Code</td>
            <td width="249" bgcolor="#eeeeee">File type <a href="#" title="Leave a blank for any extension ">?</a> </td>
		  ...
		  <!--BASIC catfile_extra-->
          <tr>
            <td><input type="text" name="catfile_extra[name][]" value="{catfile_extra.name}" /></td>
            <td><input name="catfile_extra[code][]" type="text" id="catfile_extra[code][]" value="{catfile_extra.code}" size="5" /></td>
            <td><input type="text" name="catfile_extra[type][]" value="{catfile_extra.type}" /></td>
            <td><input type="text" name="catfile_extra[note][]" value="{catfile_extra.note}" /><a href="#" onclick="delete_row(this);return false;"> x </a></td>
          </tr>
          <!--BASIC catfile_extra-->
        </table>
		<a href="#" onclick="add_file_extra('#catfile_extra','catfile_extra'); return false;">Add</a></td>
    </tr>
    <tr>
   ...
   <tr>
    ...
    <td>Resize 
      ...
      <input name="catimg_icon[h]" type="text" class="no_width" id="catimg_icon[h]" size="2" maxlength="3" value="{catimg_icon_h}"> File name: <input name="catimg_icon[name]" type="text" class="no_width" id="catimg_icon[name]" value="{catimg_icon_name}" />
...
No 
  ...
  <tr>
    ...
    <td>Resize 
      ...
      x
      <input name="catimg_thumb[h]" type="text" class="no_width" id="catimg_thumb[h]" size="2" maxlength="3" value="{catimg_thumb_h}">
	  <div class="resize_toggle_advance"><a href="#" onclick="return resize_toggle_advance(this);">Advandce</a>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="23%" bgcolor="#eeeeee">Method</td>
...
Max </td>
   ...
   <tr>
    ...
    <td>Resize 
      ...
      <input name="ln_catimg_icon[h]" type="text" class="no_width" id="ln_catimg_icon[h]" size="2" maxlength="3" value="{ln_catimg_icon_h}">
  ...
  Yes</td>
   ...
   <tr>
    ...
    <td>Resize 
      ...
      x
      <input name="ln_catimg_img[h]" type="text" class="no_width" id="ln_catimg_img[h]" size="2" maxlength="3" value="{ln_catimg_img_h}">
...
No 
  ...
  <tr>
    ...
    <td>Resize 
      ...
      x
      <input name="ln_catimg_thumb[h]" type="text" class="no_width" id="ln_catimg_thumb[h]" size="2" maxlength="3" value="{ln_catimg_thumb_h}">
	  <div class="resize_toggle_advance"><a href="#" onclick="return resize_toggle_advance(this);">Advandce</a>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="23%" bgcolor="#eeeeee">Method</td>
